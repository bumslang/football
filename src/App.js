...
function App() {
  ...
  let arr = [
    ...
    ['Ковентри Сити', 0, 3, 'Борнмут', 'П1', 2.52, 390, "плюс", '18.04.2022'],
    ['Монца', 1, 1, 'Брешиа', 'ТМ2,5', 1.81, 390, "плюс", '18.04.2022'],
    ['Вестерн Юнайтед', 2, 0, 'Макартур Сидней', 'ТБ2,5', 1.74, 390, "минус", '19.04.2022'],
    ['Виссел Кобе', 2, 1, 'Китчи', 'ТБ2,5', 1.81, 390, "плюс", '19.04.2022'],
    ['ВС Уондерерс', 3, 2, 'Ньюкасл Джетс', 'ТБ2,5', 1.78, 390, "плюс", '20.04.2022'],
    ['Анже', 0, 3, 'ПСЖ', 'Ф2(-1)', 1.82, 390, "плюс", '20.04.2022'],
    ['Осасуна', 1, 3, 'Реал Мадрид', 'П2', 1.67, 390, "плюс", '20.04.2022'],
    ['Мельбурн Сити', 2, 1, 'Чоннам Драгонз', 'П1', 1.65, 390, "плюс", '21.04.2022'],
    ['Реал Сосьедад', 0, 1, 'Барселона', 'П2', 2.19, 390, "плюс", '21.04.2022'],
    ['Макартур Сидней', 1, 4, 'Мельбурн Виктори', 'ТБ2,5', 1.72, 390, "плюс", '22.04.2022'],
    ['Карлсруэ', 2, 2, 'Ингольштадт-04', 'П1', 1.93, 390, "минус", '22.04.2022'],
    ['Аризона Кайотс', 0, 2, 'Вашингтон Кэпиталс', 'Ф1(-1)', 1.63, 390, "плюс", '23.04.2022'],
    ['Ньюкасл Джетс', 2, 4, 'Централ кост Маринер', 'ТБ2,5', 1.65, 390, "плюс", '23.04.2022'],
    ['Лутон', 2, 2, 'Блэкпул', 'П1', 1.83, 390, "минус", '23.04.2022'],
    ['Венеция', 1, 3, 'Аталанта', 'Ф2(-1)', 1.87, 390, "плюс", '23.04.2022'],
    ['Кельн', 1, 3, 'Арминия', 'Ф1(-1)', 1.7, 390, "плюс", '23.04.2022'],
    ['Детройт Ред Уингз', 2, 7, 'Питтсбург Пингвинс', 'Ф2(-1,5)', 1.84, 390, "плюс", '23.04.2022'],
  ...
  let result = arr.map((elem, ind) => {
    ...
    return <>
      <tr key={nanoid()} style={{ backgroundColor: elem[7] === 'минус' ? '#ff8383' : '#2aff85' }}>
        ...
        <td>{elem[5]}</td>
        <td>{elem[6]}</td>
        <td>{elem[7] === 'минус' ? -elem[6] : (elem[6] * elem[5] - elem[6]).toFixed(0)}</td>
      </tr>
    </>
  })
  ...
  return <>
    <table style={{ fontSize: '20px' }} >
      <thead>
        ...
        {result}
        <tr style={{ backgroundColor: '#9ed7eb' }} >
          <td>Итог: {sum ? "+" + sum.toFixed(0) : sum} руб.</td>
        </tr >
        <tr style={{ backgroundColor: '#9ed7eb' }} >
